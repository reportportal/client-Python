...
class RPRootTestItem(RPBaseTestItem):
    ...
    def __init__(self, rp_url, session, api_version, project_name, item_name, item_type, launch_uuid, description=None,
        ...
        super(RPRootTestItem, self).__init__(rp_url, session, api_version, project_name, item_name, item_type,
    ...
    def start(self, start_time):
        ...
        """
        endpoint = "{rp_url}/api/{api_version}/{project_name}/item".format(rp_url=self.rp_url,
